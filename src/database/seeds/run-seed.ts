...
export async function runSeed() {
  ...
  if (!dbStore.assets.some((a: any) => a.name?.includes('Product Showcase') || a.title?.includes('Product Showcase'))) {
    const acmeAsset1Id = uuidv4();
    const acmeAsset2Id = uuidv4();
    const acmeAsset3Id = uuidv4();
    const acmeAsset4Id = uuidv4();
    const acmeAsset5Id = uuidv4();
    const acmeAsset6Id = uuidv4();
    const acmeAsset7Id = uuidv4();
    ...
    dbStore.assets.push(
      ...
      } as any,
      {
        ...
        organizationId: org.id,
        programId: seedPrograms[0]?.id || uuidv4(),
        name: 'Acme Official Vector Logo & Icon Kit',
        title: 'Acme Official Vector Logo & Icon Kit',
        ...
        sourceType: 'FILE' as any,
        fileName: 'acme-official-logos.zip',
        fileExtension: 'zip',
        ...
        createdBy: admin.id,
        createdAt: new Date(Date.now() - 38 * 86400000),
        updatedAt: new Date(Date.now() - 38 * 86400000),
      } as any,
      {
        id: acmeAsset3Id,
        organizationId: org.id,
      ...
      } as any,
      {
        ...
        description: 'Proven email swipe copy explaining AWS Kubernetes cost reduction with coupon placeholders.',
        assetType: 'EMAIL_TEMPLATE' as any,
        sourceType: 'TEXT' as any,
        textContent: `Subject: How we cut 42% off our monthly AWS Kubernetes bill ⚡\n\nHey {{subscriber_name}},\n\nGet 20% off your first 3 months using code {{coupon_code}}:\n{{affiliate_link}}\n\nCheers,\n{{partner_name}}`,
        fileSize: 48000,
        status: 'PUBLISHED' as any,
        isPublicToAffiliates: true,
      ...
      } as any,
      {
        ...
        organizationId: org.id,
        programId: seedPrograms[0]?.id || uuidv4(),
        name: 'PartnerIQ Architecture & Security Whitepaper',
        title: 'PartnerIQ Architecture & Security Whitepaper',
        description: 'Enterprise technical whitepaper detailing SOC2 compliance, tenant isolation, and double-entry ledger architecture.',
        assetType: 'PDF' as any,
        sourceType: 'FILE' as any,
        fileName: 'partneriq-architecture-whitepaper.pdf',
        fileExtension: 'pdf',
        mimeType: 'application/pdf',
        fileSize: 8520000,
        storageUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=1600&auto=format&fit=crop&q=80',
        thumbnailUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=400&auto=format&fit=crop&q=80',
        previewUrl: 'https://images.unsplash.com/photo-1586281380349-632531db7ed4?w=1600&auto=format&fit=crop&q=80',
        status: 'PUBLISHED' as any,
        isPublicToAffiliates: true,
        isDownloadable: true,
        isCopyable: false,
        version: 1,
        tags: ['Whitepaper', 'Enterprise', 'Security', 'PDF'],
      ...
      } as any,
      {
        ...
        organizationId: org.id,
        programId: seedPrograms[0]?.id || uuidv4(),
        name: 'Interactive Product Demo Teaser (1080p MP4)',
        title: 'Interactive Product Demo Teaser (1080p MP4)',
        description: '30-second high-energy product feature highlight video for social media campaigns.',
        assetType: 'VIDEO' as any,
        sourceType: 'FILE' as any,
        fileName: 'product-demo-teaser-1080p.mp4',
        fileExtension: 'mp4',
        mimeType: 'video/mp4',
        fileSize: 45200000,
        storageUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1600&auto=format&fit=crop&q=80',
        thumbnailUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&auto=format&fit=crop&q=80',
        previewUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1600&auto=format&fit=crop&q=80',
        status: 'PUBLISHED' as any,
        isPublicToAffiliates: true,
        isDownloadable: true,
        isCopyable: false,
        version: 1,
        tags: ['Demo', 'Video', 'Reels', 'Product'],
        metadata: { folderPath: 'Ad Creatives' },
        createdBy: admin.id,
        createdAt: new Date(Date.now() - 20 * 86400000),
      ...
      } as any,
      {
        id: acmeAsset7Id,
        organizationId: org.id,
        name: 'Black Friday & Cyber Monday Social Copy Swipe File',
        title: 'Black Friday & Cyber Monday Social Copy Swipe File',
        description: 'Draft copy for upcoming holiday marketing campaigns.',
        assetType: 'SOCIAL_COPY' as any,
        sourceType: 'TEXT' as any,
        textContent: '🚀 Biggest discount of the year is live! Get 40% off PartnerIQ using code BF40 at checkout: {{affiliate_link}}',
        fileSize: 12000,
        status: 'DRAFT' as any,
        ...
        isCopyable: true,
        version: 1,
        tags: ['Black Friday', 'Draft', 'Social Copy'],
        metadata: { folderPath: 'Email Copies' },
        createdBy: admin.id,
      ...
      } as any,
      {
        ...
        name: 'ZenPay Instant UPI Checkout Video Teaser',
        title: 'ZenPay Instant UPI Checkout Video Teaser',
        assetType: 'VIDEO' as any,
        sourceType: 'FILE' as any,
        fileName: 'zenpay-upi-teaser.mp4',
        fileSize: 38600000,
        storageUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1600&auto=format&fit=crop&q=80',
        thumbnailUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=400&auto=format&fit=crop&q=80',
        previewUrl: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1600&auto=format&fit=crop&q=80',
    ...
    // Seed versions for acmeAsset1Id
    dbStore.assetVersions.push(
      {
        id: uuidv4(),
        assetId: acmeAsset1Id,
        versionNumber: 1,
        fileName: 'product-showcase-v1.png',
        mimeType: 'image/png',
        fileSize: 1720000,
        storageUrl: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&auto=format&fit=crop&q=80',
        changeNotes: 'Initial design draft',
        isCurrent: false,
        createdBy: admin.id,
        createdAt: new Date(Date.now() - 40 * 86400000),
      } as any,
      {
        ...
        fileSize: 1845000,
        storageUrl: 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1600&auto=format&fit=crop&q=80',
        changeNotes: 'Updated CTA button contrast and typography',
        isCurrent: true,
        createdBy: admin.id,
    ...
    const firstAffiliateId = dbStore.affiliates.find((a) => a.organizationId === org.id)?.id || uuidv4();
