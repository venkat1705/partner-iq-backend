...
export enum AffiliateStatus {
  ...
  ACTIVE = 'ACTIVE',
  /**
   * Paused: the partner is dormant but in good standing, which is a different
   * thing from SUSPENDED (a policy action taken against them). The portal has
   * always exposed PAUSE and SUSPEND as separate bulk actions, but this value
   * was missing, so PAUSE assigned `undefined` to the status column.
   */
  INACTIVE = 'INACTIVE',
  SUSPENDED = 'SUSPENDED',
  REJECTED = 'REJECTED',
...
export enum AuditAction {
  ...
  PAYOUT_FAILED = 'PAYOUT_FAILED',
  RECONCILIATION_RUN_TRIGGERED = 'RECONCILIATION_RUN_TRIGGERED',
  ADMIN_RECONCILIATION_RESOLVED = 'ADMIN_RECONCILIATION_RESOLVED',
  ...
  TAX_CERTIFICATE_PUBLISHED = 'TAX_CERTIFICATE_PUBLISHED',
  TAX_CERTIFICATE_UPDATED = 'TAX_CERTIFICATE_UPDATED',
  TAX_CERTIFICATE_UNPUBLISHED = 'TAX_CERTIFICATE_UNPUBLISHED',
  TAX_CERTIFICATE_DELETED = 'TAX_CERTIFICATE_DELETED',
  TAX_CERTIFICATE_DOWNLOADED = 'TAX_CERTIFICATE_DOWNLOADED',
  ...
  AFFILIATE_AVATAR_UPLOADED = 'AFFILIATE_AVATAR_UPLOADED',
  AFFILIATE_TAX_PROFILE_UPDATED = 'AFFILIATE_TAX_PROFILE_UPDATED',
  AFFILIATE_PAYOUT_METHOD_ADDED = 'AFFILIATE_PAYOUT_METHOD_ADDED',
  AFFILIATE_PAYOUT_METHOD_DELETED = 'AFFILIATE_PAYOUT_METHOD_DELETED',
  AFFILIATE_PAYOUT_METHOD_DEFAULT_SET = 'AFFILIATE_PAYOUT_METHOD_DEFAULT_SET',
  ...
  AFFILIATE_INVITATION_DECLINED = 'AFFILIATE_INVITATION_DECLINED',
  AFFILIATE_LINK_CREATED = 'AFFILIATE_LINK_CREATED',
  AFFILIATE_LINK_DELETED = 'AFFILIATE_LINK_DELETED',
  AFFILIATE_PAYOUT_REQUESTED = 'AFFILIATE_PAYOUT_REQUESTED',
  AFFILIATE_SUPPORT_TICKET_CREATED = 'AFFILIATE_SUPPORT_TICKET_CREATED',
  ...
  BLOG_SCOPE_CHANGED = 'BLOG_SCOPE_CHANGED',
  // Security Operations
  SECURITY_ALERT_ACKNOWLEDGED = 'SECURITY_ALERT_ACKNOWLEDGED',
  SECURITY_ALERT_ASSIGNED = 'SECURITY_ALERT_ASSIGNED',
  ...
  SECURITY_INVESTIGATION_RESOLVED = 'SECURITY_INVESTIGATION_RESOLVED',
  ...
  SECURITY_ALL_SESSIONS_REVOKED = 'SECURITY_ALL_SESSIONS_REVOKED',
  SECURITY_CREDENTIAL_ROTATED = 'SECURITY_CREDENTIAL_ROTATED',
  SECURITY_CREDENTIAL_REVOKED = 'SECURITY_CREDENTIAL_REVOKED',
  SECURITY_RULE_CREATED = 'SECURITY_RULE_CREATED',
  SECURITY_RULE_UPDATED = 'SECURITY_RULE_UPDATED',
  SECURITY_RULE_TOGGLED = 'SECURITY_RULE_TOGGLED',
  SECURITY_DATA_EXPORTED = 'SECURITY_DATA_EXPORTED',
  SECURITY_EXCEPTION_CREATED = 'SECURITY_EXCEPTION_CREATED',
  SECURITY_EXCEPTION_REVOKED = 'SECURITY_EXCEPTION_REVOKED',
  INTERNAL_API_CALLED = 'INTERNAL_API_CALLED',
}
